...
public class Circle {
	...
	public boolean contains(Circle circle) {
		return distanceCircle(this,circle) < Math.abs(this.radius -circle.radius);
	}
	...
	public boolean overlaps(Circle circle) {
		...
		return  Math.abs(this.radius-circle.radius)< distanceCircle(this,circle) && distanceCircle(this,circle) < (this.radius+circle.radius);
